...
### Probability of "No Events" So Far
...
\Longrightarrow \log\left[ \mathbb{P}(0|t \le T) \right] &= - \lambda t + C \\
...
### Probability of $n$ Events So Far
