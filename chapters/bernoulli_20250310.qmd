...
2. Derive the Binomial distribution from the Bernoulli distribution.

3. Derive the Geometric distribution from the Bernoulli distribution.

4. Derive the Negative binomial distribution from the Bernoulli distribution.

5. Using the dataset found in @wu_using_2020, calculate method of moments estimators for the variables `Obesity` and `Energy` (Go to the [Availability of data and materials](https://ehjournal.biomedcentral.com/articles/10.1186/s12940-020-00642-6#availability-of-data-and-materials)) section to download the data.
